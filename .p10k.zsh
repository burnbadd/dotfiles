# Generated by Powerlevel10k configuration wizard on 2025-06-15 at 10:34 BST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_FOREGROUND=15  # white
  ...
  # Custom icon: Git (nf-mdi-git, codepoint f1d2)
